<template>
    <div ref="background_div" class="transition-all background_div w-full h-full">
    </div>
    <div v-show="emblem" class="absolute z-50 p-5 bg-white overflow-hidden rounded-2xl" style="width: 70rem; left: 50%; top: 50%; transform: translate(-50%, -50%)">
        <img src="/public/images/Accountant_emblem.jpg" class="" alt="emblem" style="">
        <div class="absolute right-5 top-5 px-4 rounded-xl bg-red-400" @click="emblem = false; this.$refs.background_div.classList.remove('back')">
            <h3 class="font-black text-white text-5xl mb-2">x</h3>
        </div>
    </div>
</template>
    ...
    export default{
        ...
        methods: {
            startGame() {
                ...
                document.getElementsByClassName("accountant_mark")[0]?.classList.add('animationMark')
                document.getElementsByClassName("accountant_mark")[0]?.addEventListener("click", this.seeMark)
            ...
            controller() {
                document.getElementsByClassName("woman_control")[0].style.opacity = "0"
                document.getElementsByClassName("woman")[0].style.opacity = "1"
            ...
            seeMark(){
                event.target.classList.remove('animationMark')
                this.emblem = true
